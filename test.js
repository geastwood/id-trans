Ext.define("IA.pixelcarrier.view.grid.Log", {
    ...
    tr: {
        logUser: 'User',
        logLastChange: 'Last<br/>Change',
        logChanges: 'Changes',
        logChangeTooltipStr: "data-qtip='{0}'",
        logStatus: 'Status',
        logUserFormatted: '{0} {1} ({2})',
        logChangesFormated: '"{0}" changed from "{1}" to "{2}"',
        logChangesNoChangeMsg: 'There is no change made yet.',
